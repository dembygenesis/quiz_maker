...
import (
	"github.com/dembygenesis/quiz_maker/src/v3/api/pages/quiz"
	"github.com/gofiber/fiber/v2"
	"github.com/gofiber/fiber/v2/middleware/cors"
	"github.com/gofiber/fiber/v2/middleware/logger"

	"github.com/dembygenesis/quiz_maker/src/v1/api/middlewares/user"
	crud2 "github.com/dembygenesis/quiz_maker/src/v3/api/pages/cases"
	"github.com/dembygenesis/quiz_maker/src/v3/api/pages/user_management/case_access"
	"github.com/dembygenesis/quiz_maker/src/v3/api/pages/user_management/crud"
)
...
func mapUrlsV3(app *fiber.App) {
	...
	api.Post("/user-management/crud/login", userManagementCrud.Login)
